...
<html>
    ...
    <body>
        <section class="main">
            <section id="buttons">
                <table>
                <tr><td><button id="get-still" style="display:none">Restart</button><iframe id="ifr" style="display:none"></iframe></td><td>Relay:<span id="state">OFF</span></td><td></td></tr>
                <tr><td>MirrorImage<select id="mirrorimage"><option value="1">yes</option><option value="0">no</option></select></td><td style="display:none"><button id="toggle-stream"></button></td><td></td></tr>
